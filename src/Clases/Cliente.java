...
public class Cliente {
    ...
    public String getDepartamento_res() {
        return departamento_res;
    }

    public void setDepartamento_res(String departamento_res) {
        this.departamento_res = departamento_res;
    }
